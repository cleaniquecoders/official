...
**NEVER use `bg-card` for card backgrounds** - this creates yellowish backgrounds that break design consistency.

**Standard Card Pattern (ALWAYS use this):**
```tsx
// Main cards (like Services, Projects, Open Source featured cards)
<div className="p-8 bg-background/50 backdrop-blur-sm border border-border rounded-3xl">

// Smaller cards (like Projects grid items, Open Source popular/recent cards)
...
- **Section Backgrounds**: `bg-card/30` (sections only, not individual cards)
...
13. **CRITICAL: Use consistent card styling** - Always use `bg-background/50 backdrop-blur-sm border border-border` for cards, NEVER `bg-card/50`
